...
const views = path.join(root, 'src', 'views', 'openPlatform')
const components = path.join(views, 'components')

const webhookSecretRotateModal = `<template>
  <a-modal
    :visible="visible"
    :title="modalTitle"
    :width="640"
...
fs.writeFileSync(path.join(components, 'WebhookSecretRotateModal.vue'), webhookSecretRotateModal, 'utf8')
console.log('[write-webhook-secret-ui] WebhookSecretRotateModal OK')
